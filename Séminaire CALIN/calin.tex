...
\begin{frame}{Conduction électrique de chaînes d'atomes}
...
\(
	...
	\<{6cm}
\begin{itemize}
	\item Chaîne périodique : le courant passe si $E_\text{incident} \in [-2t, 2t]$.
	\item Chaîne quasi : le courant passe si $E_\text{incident} \in \text{ensemble de Cantor}$ (voir \emph{Niu \& Nori, PRB 1990})
\end{itemize}
	\>
\)
