...
\only<2>{
\begin{itemize}
	\item {\color{BostonBlue}Blue labeled} gaps have a stable label gap label $\rightarrow$ {\color{BostonBlue}stable} gaps.
	\item {\color{Complementary}Red labeled} do not $\rightarrow$ {\color{Complementary}transient} gaps.
\end{itemize}
}
