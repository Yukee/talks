...
\usepackage[natbib=true, backend=biber, style=numeric, doi=false,isbn=false,url=false]{biblatex}
...
\begin{figure}[htp]
	...
	\begin{minipage}{0.3\textwidth}
		...
		\label{fig:width3}
	\end{minipage}
	\center{Gap width as a function of gap label for several quasiperiodic chains. Blue: stable gap, red: transient gaps, according to criterion \eqref{eq:overlapcriterion}.}
\end{figure}
