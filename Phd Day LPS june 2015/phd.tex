...
\begin{frame}{Electron dynamics on quasiperiodic tilings}
	...
	\begin{tikzpicture}[scale=.7]
		...
		\end{tikzpicture}
	\item Whenever $\rho = t_A / t_B \neq 1$, the chain is quasiperiodic.
		\begin{itemize}
...
\begin{frame}{Renormalization}
	...
	\begin{itemize}
		\item Electron dynamics?
		\begin{itemize}
			\item No translational invariance $\rightarrow$ no Bloch theorem.
			\item But scale invariance $\rightarrow$ renormalization group approach 
			
			{(\scriptsize Niu \& Nori 90, Kalugin, Kitaev \& Levitov 89)}
		\end{itemize}
