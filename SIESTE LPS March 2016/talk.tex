...
\begin{frame}
\title{Electronic states on quasicrystals}

\author{ Nicolas Macé}

%\institute{Laboratoire de Physique des Solides}
...
\ss{A one dimensional tiling, built from a 2D square lattice.}
...
\ss{The integrated density of states of the Fibonacci chain.} 
\end{frame}
